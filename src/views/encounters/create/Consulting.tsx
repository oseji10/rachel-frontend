...
const refractionAxis = [
    ...
    // ... (other axis values, abbreviated for brevity)
...
const diagnosisList = [
    ...
    {"id": 5, "name": "Cataracts"},
    // ... (other diagnoses, abbreviated for brevity)
...
const nearAdd = [
    {"id": 1, "name": "+0.75"},
    {"id": 2, "name": "+1.00"},
    // ... (other near add values, abbreviated for brevity)
    {"id": 12, "name": "+3.50"}
];
...
const refractionCylinder = [
    {"id": 1, "name": "-10.75D"},
    {"id": 2, "name": "-10.50D"},
    // ... (other cylinder values, abbreviated for brevity)
    {"id": 87, "name": "+10.75D"}
];
...
const refractionSphere = [
    {"id": 1, "name": "-10.75D"},
    {"id": 2, "name": "-10.50D"},
    // ... (other sphere values, abbreviated for brevity)
    {"id": 87, "name": "+10.75D"}
];
...
const refractionPrism = [
    {"id": 1, "name": "-20.0Δ"},
    {"id": 2, "name": "-19.0Δ"},
    // ... (other prism values, abbreviated for brevity)
    {"id": 41, "name": "20.0Δ"}
];
...
const investigationsRequiredList = [
    ...
    // ... (other investigations, abbreviated for brevity)
    {"id": 999, "name": "Other"}
];
...
const investigationsDoneList = [
    ...
    // ... (other investigations done, abbreviated for brevity)
    {"id": 999, "name": "Other"}
];
